...
<a href="https://peanut.pa7lim.nl/radio/?room=YSF-ADER" target="_blank" class="btn btn-sm" style="background:#00b894;color:#000;font-weight:700;">🥜 PEANUT</a><button id="btnReboot" class="btn btn-danger btn-sm" onclick="rebootPi()">⏻ REINICIAR PI</button>
</div>
</header>
